...
# Usage: python dtxs-client.py <configFile> <command> [arg1] [arg2] ...
# Examples:
#   python dtxs-client.py dtxs-client-config.json list-databases
#   python dtxs-client.py dtxs-client-config.json list-records db_test_1
#   python dtxs-client.py dtxs-client-config.json list-documents db_test_1
#
...
match cmd:
  ...
  case "list-records":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py list-records <database>")
    else:
  ...
  case "get-record":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py get-record <database> <recordUid>")
    else:
  ...
  case "get-record-history":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py get-record-history <database> <recorUid>")
    else:
      recordUid = sys.argv[4]
  ...
  case "create-record":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py create-record <database> <recordClass> <content>")
    else:
      ...
      if ('error' in recordUid):
        ...
        print("Record created. UID = " + recordUid)
  ...
  case "update-record":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py update-record <database> <recordUid> <recordClass> <content>")
    else:
      recordUid = sys.argv[4]
  ...
  case "delete-record":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py delete-record <database> <recordUid>")
    else:
      recordUid = sys.argv[4]
  ...
  case "create-folder":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py create-folder <database> <folderName> <parentFolderUID>")
    else:
  ...
  case "get-folder-contents":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py get-folder-contents <database> <folderUid>")
    else:
  ...
  case "delete-folder":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py delete-folder <database> <folderUid>")
    else:
      folderUid = sys.argv[4]
      client.database = database
  ...
  case "list-documents":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py list-documents <database>")
    else:
      print("Getting records from database '" + database + "'.")
      client.database = database
  ...
  case "get-document":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py get-document <database> <folderUid> <documentUid>")
    else:
      folderUid = sys.argv[4]
  ...
  case "upload-document":
    if (len(sys.argv) == 6):
      ...
      print('Document uploaded. UID = ' + documentUid)
    else:
      print('Usage: dtxs-client.py upload-document <database> <pathToFile> <folderUid>')
  ...
  case "delete-document":
    ...
    if (database == ''):
      print("Usage: dtxs-client.py delete-document <database> <folderUid> <documentUid>")
    else:
      folderUid = sys.argv[4]
      documentUid = sys.argv[5]
